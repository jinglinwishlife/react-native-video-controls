...
export default class VideoPlayer extends Component {
    ...
    */
    ...
    _onLoad( data = {} ) {
        ...
        if ( state.showControls && !!this.props.disableTimeout ) {
    ...
    */
     ...
     */
    setControlTimeout() {
        if (this.props.disableTimeout) return;
    ...
    */
    ...
    renderTopControls() {
        ...
        if (this.props.disableBack && this.props.disableVolume && this.props.disableFullscreen) {
            return null;
        }
